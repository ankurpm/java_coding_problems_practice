...
public class StatsCalUnsolvedTest {
    @Test
    void testMean() {
        assertEquals(3.0, StatsCalUnsolved.mean(Arrays.asList(1, 2, 3, 4, 5)));
        assertEquals(15.0, StatsCalUnsolved.mean(Arrays.asList(10, 20)));
    }
